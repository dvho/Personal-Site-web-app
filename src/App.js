...
class App extends React.PureComponent {
    ...
    calcAllDimensionsCoordsAndResetClouds = (e) => {
        ...
        } else if (e.type === 'mouseover' || e.type === 'mousemove' || e.type === 'touchstart' || e.type === 'touchend') { //Get the X and Y positions on mouseover, mousemove, touchstart, and touchend
    ...
    componentDidMount() {
        ...
        ['load', 'resize', 'mouseover', 'mousemove', 'touchstart', 'touchend'].forEach(i => window.addEventListener(i, this.calcAllDimensionsCoordsAndResetClouds))
