...
class App extends React.PureComponent {
    ...
    calcAllDimensionsCoordsAndResetClouds = (e) => {
        ...
        } else if (e.type === 'mouseover' || e.type === 'mousemove' || e.type === 'touchstart' || e.type === 'touchend' || e.type === 'touchmove') { //Get the X and Y positions on mouseover, mousemove, touchstart, touchend and touchmove
    ...
    componentDidMount() {
        ...
        ['load', 'resize', 'mouseover', 'mousemove', 'touchstart', 'touchmove'].forEach(i => window.addEventListener(i, this.calcAllDimensionsCoordsAndResetClouds))
