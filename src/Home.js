...
class Home extends React.PureComponent {
    ...
    componentDidMount() {
        ...
        ['load', 'resize', 'mousemove', 'touchmove', 'click', 'onmousedown', 'onmouseup'].forEach(i => window.addEventListener(i, this.calcAllDimensionsCoordsAndResetClouds)) //onmousedown and onmouseup are needed for the onHold function used in Track.js
