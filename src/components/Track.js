...
class Track extends React.PureComponent {
    ...
    render() {
        ...
        let customFont = 'Nothing You Could Do, cursive'
        ...
        return(
            ...
            <div style={{position: 'relative', left: leftOrRightPosition}} onClick={() => this.props.selectTrack(this.props.track)}>
                <h1 style={{color: isSelected ? 'rgba(120,160,192,1)' : 'rgba(255,255,255,.65)', margin: textMargin, fontSize: fontSizeCalc, fontFamily: customFont, transition: 'all .10s'}} className='title'>{this.props.trackNumber}. {trackTitle}</h1>
            </div>
